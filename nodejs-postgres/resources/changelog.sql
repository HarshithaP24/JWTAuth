...
CREATE INDEX IF NOT EXISTS idx_eg_test_user_table_active
...
CREATE INDEX IF NOT EXISTS idx_eg_test_user_table_mobile
    ON public.eg_test_user_table USING btree
...
CREATE INDEX IF NOT EXISTS idx_eg_test_user_table_name
    ON public.eg_test_user_table USING btree
...
CREATE INDEX IF NOT EXISTS idx_eg_test_user_table_tenantid
    ON public.eg_test_user_table USING btree
...
CREATE INDEX IF NOT EXISTS idx_eg_test_user_table_type
    ON public.eg_test_user_table USING btree
...
CREATE INDEX IF NOT EXISTS idx_eg_test_user_table_username
    ON public.eg_test_user_table USING btree
...
CREATE INDEX IF NOT EXISTS idx_eg_test_user_table_uuid
    ON public.eg_test_user_table USING btree
